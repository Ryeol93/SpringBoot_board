...
public class LogAspect {
    @Before("@annotation(com.example.ex05.aspect.anotation.LogStatus)")
     ...
     * doAdd 메소드 리턴 후 Ascpert를 사용하여 메소드의 이름과 리터된 시간을 출력하는 주변로직 구현
     * */
    @After("@annotation(com.example.ex05.aspect.anotation.LogStatus)")
    ...
    @AfterReturning(value = "@annotation(com.example.ex05.aspect.anotation.LogStatus)" , returning = "returnValue")
    public void ReturningStart(JoinPoint joinPoint, Integer returnValue){
        log.info("=================================================");
        log.info("Method " + joinPoint.getSignature().getName()+ " Returned " + returnValue + " at" + LocalDateTime.now());
        log.info("=================================================");
    }

    @AfterThrowing(value = "@annotation(com.example.ex05.aspect.anotation.LogStatus)", throwing = "e")
