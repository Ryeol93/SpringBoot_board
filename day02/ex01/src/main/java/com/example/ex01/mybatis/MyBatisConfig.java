...
@Configuration//was에서 스프링컨테이너가 등록이 될때 이 파일을 들렀다 가라고 @Configuration을 써준다
@RequiredArgsConstructor
@MapperScan("com.example.ex01.mappers") // mapper를 스캔해주는 @MapperScan("경로")
...
//    HikariDataSource에 hikariConfig()을 전달하고 싶다
