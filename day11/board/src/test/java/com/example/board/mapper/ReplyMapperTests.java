...
public class ReplyMapperTests {
    ...
    public void testGetTotal(){
        log.info("------------------------------------------------------");
        log.info(String.valueOf(mapper.getTotal(353L)));
        log.info("------------------------------------------------------");
    }
...
//        log.info("------------------------------------------------------");
//        mapper.getList(353L, new Criteria(1, 10)).stream().map(v -> v.toString()).forEach(log::info);
//        log.info("------------------------------------------------------");
//    }
...
//            log.info("------------------------------------------------------");
//            log.info("DELETE COUNT : " + mapper.remove(5L));
//            log.info("------------------------------------------------------");
//            return;
//        }
